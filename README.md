...
## [⬇️ СКАЧАТЬ APK (последняя версия)](https://github.com/Efimo/tracker/releases/latest/download/StepanTracker.apk)

> Ссылка всегда ведёт на последний релиз. Нажми → скачается → установи на Android.
